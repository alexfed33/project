...
$id = $_GET['id'];
$user_profile = get_user_by_id($id);
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href=""><?echo $user_profile['email'];?></a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    ...
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        ...
                                        <small class="text-muted mb-0"><?echo $user_profile['jobs'];?></small>
                                    </h5>
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i><?echo $user_profile['phone'];?></a>
                                    <a href="mailto:oliver.kopyov@marlin.ru" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?echo $user_profile['email'];?></a>
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?echo $user_profile['address'];?>
                                    </address>
                                </div>
                            </div>
                        </div>
