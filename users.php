    ...
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="users.php"> <? echo $_SESSION['user'];?></a>
                    </li>
                    <li class="nav-item">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                ...
                <? foreach (query_to_users() as $users) { ?>
                                            ...
                                            <? if ($_SESSION['role'] == 'admin') { ?>
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="edit.php?id=<?echo $users['id'];?>">
                                                        ...
                                                        Редактировать</a>
                                                    <a class="dropdown-item" href="security.php?id=<?echo $users['id'];?>">
                                                        <i class="fa fa-lock"></i>
                                                        Безопасность</a>
                                                    <a class="dropdown-item" href="status.php?id=<?echo $users['id'];?>">
                                                        <i class="fa fa-sun"></i>
                                                        Установить статус</a>
                                                    <a class="dropdown-item" href="media.php?id=<?echo $users['id'];?>">
